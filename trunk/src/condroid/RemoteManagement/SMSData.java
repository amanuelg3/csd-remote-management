...
public class SMSData {
	 ...
	 */
	static String mRemoteLocation = "";		// Selected database columns
	static String mRemotePhoneNumber = "";
	static String mRemoteDeviceType = "";
	
	static String mUserPassCode = "";
	static String mRandomNumber = "";
	static String mCryptoPassCode = "";
	static String mAuthorizedPassCode = "";
	...
	/*=============================================================================
	 * Name: saveDatabaseItems
	 * 
	 * Description:
	 * 		Save the selected item from database to SMSData class static variables
	 *=============================================================================*/	
	public void saveDatabaseItems(String location, String phonenum, String device)
	{
